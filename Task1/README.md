...
## Задача 3. Обеспечить безопасное получение и хранение access-и refresh-токенов
...
## Задача 4. Добавить LDAP для возможности получения данных о пользователях представительства BionicPRO в другой стране

[Настройка](/Task1/Task1-4/README.md)
...
## Задача 5. Настрока MFA

[Настройка](/Task1/Task1-5/README.md)
...
3. После настройки OTP — каждый вход требует код
   Har-Лог с примером: [mfa-sample2.har](/Task1/Task1-5/mfa-sample2.har)

   ![screen1](/Task1/Task1-5/Screenshot_mfa2.png)

## Задача 6. Добавить OAuth 2.0 от Яндекс ID

[Описание реализации](/Task1/Task1-6/README.md)
